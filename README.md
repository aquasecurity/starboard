...
[custom resource definitions][starboard-crds] and a [Go module][starboard-go-module] to work with a range
...
To read more about custom resources and label selectors check [Custom Resource Definitions][starboard-crds].
...
[starboard-crds]: https://aquasecurity.github.io/starboard/crds/

...
func (w *ReadWriter) Write(ctx context.Context, report starboard.CISKubeBenchOutput, node *core.Node) (err error) {
	klog.V(3).Infof("Trying to create CISKubeBenchReport for %s node", node.Name)

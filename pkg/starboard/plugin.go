...
//
// PluginContext methods allow plugin to:
//
// - Get the Starboard Namespace
//
// - Get the name of the ServiceAccount used by Starboard
type PluginContext interface {
	// GetNamespace return the name of the K8s Namespace where Starboard creates Jobs
	// and other helper objects.
	GetNamespace() string
	// GetServiceAccountName return the name of the K8s ServiceAccount used to run workloads
